 ...
 */
async function specToFunctionModule( specObj, prgCallbck = function() {} ) {
	...
	const g1_prompt = [
		...
		"",
		`${_humanLabel}:`,
		`Please generate the ${_pLang} module code, with the complete implementation according the spec. Without comments.`,
		"",
		`${_assistantLabel}:`,
		"```",
		""
	...
	const g3_prompt = [
		...
		"",
		`${_humanLabel}:`,
		`Please generate the ${_pLang} module code`,
		"",
		`${_assistantLabel}:`,
		"```",
		g2_codegen,
	...
	const g4_prompt = [
		...
		"",
		`${_humanLabel}:`,
		`Please improve overall readability of the code, and the code comments.`,
		"",
		`${_assistantLabel}:`,
		"```",
		""
...
module.exports = specToFunctionModule;